...
/**
 * [LUIS] - 29/09/2025 Componente React para renderizar Markdown con soporte GFM.
      ...
      <ReactMarkdown
        ...
        components={{
          ...
          code: (props) => {
            ...
            if (isInline) return <code className="rounded bg-muted px-1 py-0.5 text-sm" {...(props as any)} />
